...
%description -l pl
Celem tego zarz±dcy zasobów jest dostarczenie wspólnego szkieletu dla
...
Summary(pl):	Pliki nag³ówkowe biblioteki resmgr
...
Pliki nag³ówkowe biblioteki resmgr.
